...
<div class="grid grid-cols-3 gap-4">
    ...
    <div class="text-gray-700 col-span-2">
        ...
        <div class="flex mt-3">
            ...
            <div>
                <p class="test-gray-500 text-sm">{{$course->user->name}}</p>
                <p class="test-gray-300 text-xm">{{$course->created_at->diffForHumans()}}</p>
            </div>
        </div>
...
<div class="text-center mt-8">
    ...
    <h2 class="text-xl text-gray-600">Fórmate online como prefesonal en tecnología</h2>
</div>
